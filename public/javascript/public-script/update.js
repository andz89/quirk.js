  ...
  update_account() {
    if (document.querySelector("#modal-btn")) {
      ...
      document.querySelector("#update-btn").addEventListener("click", () => {
        let user_name = document.querySelector("#edit-user-name").value;         let user_email = document.querySelector("#edit-user-email").value;
        ...
        xhttp.open(
          "POST",
          `http://localhost:5000/update_account?user_email=${data.user_email}`,
          true
        );
        xhttp.send();
      });
