...
const run_script = (data) => {
  const open_file = () => {
    ...
    let json_parsed = JSON.parse(data.template_json);
    ...
    document.querySelector("#file_name").innerHTML = data.template_name;
    ...
    let index = 1;
    let arr = [
      { w: 632.6070623591283, h: 447.0323065364387, z: 0.7513148009015777 },
      { w: 842, h: 595, z: 1 },
